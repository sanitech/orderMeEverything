...
const CustomerMenuCard = ({
  ...
  return (
    <div
      className={`flex-1 min-w-[150px] max-w-sm bg-white rounded-lg shadow-md m-1 border transition-opacity duration-300 ease-in-out ${
        isSelected ? "border-green-500" : ""
      }`}
      onClick={handleClick}
    >
      <LazyLoadImage
        className="aspect-[4/3] object-cover rounded-xl bg-orange-100"
